...
from data.mt_dataset_transformer import MTDataset
...
class DataManager:
    ...
    def prepare_data(self):
        ...
        print("source_tokenizer ", self.source_tokenizer.tokenizer.get_vocab_size())
        ...
        print("target_tokenizer ", self.target_tokenizer.tokenizer.get_vocab_size())
        ...
        val_dataloader = DataLoader(val_dataset, shuffle=True,
                                    batch_size=self.config["batch_size"], drop_last=True)
        return train_dataloader, val_dataloader, self.source_tokenizer.tokenizer.get_vocab_size(), self.target_tokenizer.tokenizer.get_vocab_size(), self.target_tokenizer, self.source_tokenizer
